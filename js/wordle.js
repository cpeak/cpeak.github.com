import { wordList, allowedAttempts, globalSetOfWords, startDate, alphabets, qwerty } from "./wordle-game-constants.js";
...
const Wordle = function () {
  ...
  const generateScoreCard = async () => {
    let result = `Wordle ${getTheWordIndexForToday() + 1} / ${wordList.length}\n\n`;
